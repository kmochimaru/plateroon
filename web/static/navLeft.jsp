...
<div class="col-lg-3">
    ...
    <div class="list-group">
        <a href="#" class="list-group-item active"><i class="fa fa-home" aria-hidden="true"></i>&nbsp;&nbsp;เมนู</a>
        <a href="pomotion.jsp" class="list-group-item list-group-item-action"><i class="fa fa-shopping-bag" aria-hidden="true"></i>&nbsp;&nbsp;โปรโมชั่น</a>
        <a href="product.jsp" class="list-group-item list-group-item-action"><i class="fa fa-shopping-cart" aria-hidden="true"></i>&nbsp;&nbsp;สินค้า</a>
        <a href="checkAgent.jsp" class="list-group-item list-group-item-action"><i class="fa fa-users" aria-hidden="true"></i>&nbsp;&nbsp;ตรวจสอบสถานะตัวแทน</a>
        <a href="search.jsp" class="list-group-item list-group-item-action"><i class="fa fa-search" aria-hidden="true"></i>&nbsp;&nbsp;ค้นหาตัวแทน</a>
    </div>
    <div align="center">
